...
| `SKINS`        | Skins visuales: paleta + función de dibujo (Retro, Neón, Pastel, Pixel art); se elige en el selector junto al título y se guarda en `localStorage` (`skin`) | `retro` |
